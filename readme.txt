...
Installing "g_tool_tips" can be done either by searching for "g_tool_tips" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
